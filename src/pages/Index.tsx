      ...
      <div className="w-full max-w-md space-y-8">
        ...
        >
          <Card className="p-8 space-y-6 border-2 border-primary/10 shadow-xl bg-card/80 backdrop-blur-sm">
            <div className="space-y-2 text-center">
              ...
              <p className="text-muted-foreground">Sign in to book your next event</p>
            </div>
        ...
        >
          <div className="flex justify-center gap-3 text-xs text-muted-foreground/50">
            <Link to="/login/admin" className="hover:text-muted-foreground transition-colors">
              Admin Portal
            </Link>
            <span>|</span>
            <Link to="/login/owner" className="hover:text-muted-foreground transition-colors">
              Venue Owner
            </Link>
          </div>
        </motion.div>
